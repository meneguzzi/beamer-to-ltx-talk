...
%% This is a worked example from a real Beamer->ltx-talk port; copy it next to
%% your decks (e.g. as ltx-common.tex) and replace the project-specific bits:
%% colours, author/institute, and the title-page text. Load it AFTER
%% \documentclass{ltx-talk}. \DocumentMetadata must already be set (it must be
%% the very first thing in the file, before \documentclass) so tagging is active.
%%
%% Design notes:
