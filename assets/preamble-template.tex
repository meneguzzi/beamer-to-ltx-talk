...
\newcommand{\coursetitlepage}[3]{%
  ...
  \begin{frame}
    ...
    %% Tagged by hand — this is plain text in a frame, not a sectioning
    %% command, so nothing tags it for you (\title roles to /Title -> P).
    {\color{\ThemeAccent}\Huge\bfseries
     \tagstructbegin{tag=H1}\tagmcbegin{}#1\tagmcend\tagstructend}\par\vspace{0.5em}
